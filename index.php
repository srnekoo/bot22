...
// 
      ...
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
      $this->conectDB();
...
$curl = json_decode(file_get_contents('https://webhookluaa.herokuapp.com/index.php'), true);

if( ($curl['messages'][0]['fromMe'] === false) && ($curl['messages'][0]['type'] == "chat") ) {
	
	$nome = $curl['messages'][0]['senderName'];
	$phone = explode("@", $curl['messages'][0]['chatId'])[0];
	$body = $curl['messages'][0]['body'];
...
function envia_mensagem($phone, $message, $curl, $response)
{
$_SESSION['scriptcase']['blank']['contr_erro'] = 'on';
